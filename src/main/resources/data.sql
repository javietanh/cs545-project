...
VALUES (1, 'Phoenix', 'Phoenix offers fashion and quality at the best price', 2, 'APPROVED');
...
VALUES (1, 'Dress with Tie Belt',
        ...
        '34.99', true, '/img/product/beltdress.jpg', 1);
...
VALUES (2, 'Bib Overall Dress',
        ...
        '34.99', true, '/img/product/overalldress.jpg', 1);
...
VALUES (3, 'Skinny Regular Ankle Jeans',
        ...
        '9.99', true, '/img/product/skinnyjeans.jpg', 1);

INSERT INTO product (id, name, description, price, available, image, seller_id)
VALUES (4, 'Slim Jeans',
        '5-pocket jeans in washed denim with a regular waist, zip fly, and slim legs',
        '19.99', true, '/img/product/slimjeans.jpg', 1);
...
VALUES (5, 'Regular Fit Henley Shirt',
        ...
        '24.99', true, '/img/product/fitshirt.jpg', 1);
...
VALUES (6, 'Super Skinny Fit Blazer',
        ...
        '19.99', true, '/img/product/fitblazer.jpg', 1);
